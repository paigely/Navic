	...
	Scaffold(
		...
		CompositionLocalProvider(
			...
			Column(
				...
				Form {
					FormRow {
						Text(stringResource(Res.string.option_player_animate_background))
						SettingSwitch(
							checked = Settings.shared.animatePlayerBackground,
							onCheckedChange = { Settings.shared.animatePlayerBackground = it }
						)
					}
					FormRow {
